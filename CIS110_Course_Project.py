...
if checkOutbeach.lower() == "yes" :
    ...
    print("\n", seaTurtle, " continues to search the ", oceanName, " in hope that he will soon find his family that he has lost. ")
...
if seaTurtlefamily.lower() == "yes" :
    ...
    print("\nAs ",seaTurtle, " gets closer he soon realized that the family of " + str(turtleType)+ " is his family he has been searching for.  ")
    print("\n",seaTurtle, " is happy he has finally found his family, and is not alone anymore.  ")
else:
    print("\n", seaTurtle, " decides to not check because they family of " + str (turtleType)+ " does not look like his family. ")
